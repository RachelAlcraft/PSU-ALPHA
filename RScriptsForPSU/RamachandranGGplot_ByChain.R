...
#Phi/Psi
p1 <- ggplot(sub_dataA, aes(x=Phi, y=Psi,color=Chemical)) + 
...
p2 <- ggplot(sub_dataB, aes(x=Phi, y=Psi,color=Chemical)) + 
  ggtitle(paste("1BVR","B")) + 
  geom_point(size=4) + 
  scale_y_continuous(breaks = c(-180,-120,-60,0,60,120,180))+
  scale_x_continuous(breaks = c(-180,-120,-60,0,60,120,180))

p3 <- ggplot(sub_dataC, aes(x=Phi, y=Psi,color=Chemical)) + 
  ggtitle(paste("1BVR","C")) + 
  geom_point(size=4) + 
  scale_y_continuous(breaks = c(-180,-120,-60,0,60,120,180))+
  scale_x_continuous(breaks = c(-180,-120,-60,0,60,120,180))

p4 <- ggplot(sub_dataD, aes(x=Phi, y=Psi,color=Chemical)) + 
  ggtitle(paste("1BVR","D")) + 
  geom_point(size=4) + 
  scale_y_continuous(breaks = c(-180,-120,-60,0,60,120,180))+
  scale_x_continuous(breaks = c(-180,-120,-60,0,60,120,180))

p5 <- ggplot(sub_dataE, aes(x=Phi, y=Psi,color=Chemical)) + 
  ggtitle(paste("1BVR","E")) + 
  geom_point(size=4) + 
  scale_y_continuous(breaks = c(-180,-120,-60,0,60,120,180))+
  scale_x_continuous(breaks = c(-180,-120,-60,0,60,120,180))

p6 <- ggplot(sub_dataF, aes(x=Phi, y=Psi,color=Chemical)) + 
